            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="{{ asset('storage/' . $gallery->filename) }}" class="gallery-image" alt="{{ $gallery->title }}"
                             data-bs-toggle="modal" data-bs-target="#imageModal{{ $gallery->id }}" style="cursor: pointer;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text mb-0"><small class="text-muted">Uploaded by: {{ $gallery->uploader_name ?? '-' }}</small></p>
                    </div>
                     <div class="gallery-actions">
                        <a href="{{ route('dashboard.gallery.edit', $gallery->id) }}" class="btn btn-sm btn-light">
                            <i class="ri-pencil-line"></i>
                        </a>
                        <form action="{{ route('dashboard.gallery.destroy', $gallery->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this image?');">
                            @csrf
                            @method('DELETE')
