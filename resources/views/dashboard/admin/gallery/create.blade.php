                        ...
                        <form action="{{ route('dashboard.gallery.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="Tambahkan deskripsi (opsional)"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="upload-area" id="uploadArea">
                                    ...
                                    <h5 class="mt-3 mb-2" style="color: var(--text-primary);">
                                        Drag & Drop gambar atau Browse
                                    </h5>
                                    <p class="text-muted mb-0">
                                        Maksimal 5MB (JPG, PNG, GIF, WEBP)
                                    </p>
                                </div>
                                <input type="file" name="filename" id="fileInput" accept="image/*" style="display: none;"
                                    required>
