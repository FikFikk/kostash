            ...
            <div class="card-body">
                <form action="{{ route('dashboard.gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="preset_categories[]" value="room"
                                id="catRoom">
                            <label class="form-check-label" for="catRoom">Kamar</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="preset_categories[]" value="facility"
                                id="catFacility">
                            <label class="form-check-label" for="catFacility">Fasilitas</label>
                        </div>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="preset_categories[]" value="surroundings"
                                id="catDurroundings">
