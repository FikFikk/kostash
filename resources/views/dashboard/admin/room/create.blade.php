            ...
            <div class="live-preview">
                <form action="{{ route('dashboard.room.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="image" accept="image/*" onchange="validateFileSize(this)">
                        <br><small id="image-error" style="color:red;"></small>
                    </div>

                    <div class="mb-3">
                        <label for="width" class="form-label">Width (m)</label>
                        <input type="number" step="0.1" class="form-control" name="width" id="width" placeholder="Enter width" value="3.5">
                    </div>

                    <div class="mb-3">
                        <label for="length" class="form-label">Length (m)</label>
                        <input type="number" step="0.1" class="form-control" name="length" id="length" placeholder="Enter length" value="5">
                    </div>
