...
<head>
    <meta charset="utf-8" />
    <title>403 Forbidden | KostASH.id</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Access Denied" name="description" />
                    ...
                    <div class="col-lg-12">
                        <div class="text-center pt-4">
                            ...
                            <div class="mt-n4">
                                ...
                                <h3 class="text-uppercase">Akses Ditolak 😓</h3>
                                <p class="text-muted mb-4">Anda tidak memiliki izin untuk mengakses halaman ini.</p>
                                <a href="javascript:history.back()" class="btn btn-warning"><i class="mdi mdi-arrow-left me-1"></i>Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> KostASH. Crafted with <i class="mdi mdi-heart text-danger"></i> by FikFikk</p>
                        </div>
                    </div>
                </div>
            </div>
