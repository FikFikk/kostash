                        ...
                        <div class="col-12">
                            <div class="photo-upload-section text-center">
                                ...
                                <div class="photo-upload-btn">
                                    ...
                                    <input type="file" id="photo" name="photo" class="filepond" accept="image/*"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-group-elegant">
                                ...
                                <textarea class="form-control form-control-elegant @error('address') is-invalid @enderror" id="address" name="address"
