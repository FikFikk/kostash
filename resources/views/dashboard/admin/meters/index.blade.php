                    ...
                    <div class="d-flex flex-column flex-md-row align-items-md-center">
                            ...
                            <form method="GET" action="{{ route('dashboard.meter.index') }}" class="mb-0">
                                <div class="input-group">
                                    ...
                                    @if(request('year') && request('year') != now()->year)
                                        <a href="{{ route('dashboard.meter.index') }}" class="btn btn-outline-secondary" title="Reset ke tahun sekarang">
                        ...
                        @if(request('year', now()->year))
                            <div class="alert alert-info mb-0 py-2 px-3 d-flex align-items-center flex-grow-1">
                                ...
                                <div>
                                    Menampilkan data untuk tahun <strong>{{ request('year', now()->year) }}</strong>
                                </div>
                            </div>
                        @endif
                ...
                @foreach($rooms as $room)
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="7" class="text-center">Tidak ada data untuk kamar ini pada tahun {{ request('year', now()->year) }}.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                @endforeach
