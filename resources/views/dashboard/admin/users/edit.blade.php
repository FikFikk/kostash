                                ...
                                <div class="col-lg-4 border-end-lg">
                                    ...
                                    <div class="text-center mb-3">
                                        <label for="photo" class="image-preview-wrapper" id="image-upload-area">
                                            <img src="{{ $user->photo ? asset('storage/uploads/profile/' . $user->photo) : '' }}"
                                                alt="Image Preview" class="image-preview" id="image-preview"
                                                style="{{ !$user->photo ? 'display: none;' : '' }}">
                                            <div class="image-preview-placeholder" id="image-placeholder"
                                                style="{{ $user->photo ? 'display: none;' : 'display: flex; flex-direction: column; align-items: center; justify-content: center;' }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="role" id="role" class="form-select">
                                            <option value="tenants"
                                                {{ old('role', $user->role) === 'tenants' ? 'selected' : '' }}>Tenants
                                            </option>
                                            <option value="admin"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="nik" id="nik" class="form-control"
                                                value="{{ old('nik', $user->nik) }}" placeholder="Enter NIK (opsional)">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" name="date_entry" id="date_entry" class="form-control"
                                                value="{{ old('date_entry', $user->date_entry) }}">
                                        </div>
                                        <div class="col-12 mb-3">
