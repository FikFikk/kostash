                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p><strong>Water Meter:</strong> {{ $meter->water_meter_start }} → {{ $meter->water_meter_end }} (Total: {{ $meter->total_water }} m³)</p>
                                <p><strong>Electric Meter:</strong> {{ $meter->electric_meter_start }} → {{ $meter->electric_meter_end }} (Total: {{ $meter->total_electric }} kWh)</p>
                                <p><strong>Total Tagihan:</strong> Rp{{ number_format($meter->total_bill, 0, ',', '.') }}</p>
                            </div>
