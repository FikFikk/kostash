                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Contoh: Lampu kamar mandi mati" value="{{ old('title') }}">
                            @error('title')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="category" class="form-label">Kategori Kendala <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="4" placeholder="Jelaskan kendala Anda sedetail mungkin...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                     ...
                     <div class="col-md-6">
                        <div class="mb-3">
                            <label for="priority" class="form-label">Tingkat Prioritas <span class="text-danger">*</span></label>
