...
<body>
    <div class="invoice-container">
        ...
        @php
            $message =
                "Halo admin, saya {$user->name} penghuni {$room->name} ingin membayar tagihan kost sebesar Rp" .
		...
		">
            <img src="data:image/svg+xml;base64, {!! base64_encode(
                QrCode::format('svg')->size(100)->style('square')->eyeColor(0, 200, 0, 0, 200, 200, 0)->eyeColor(1, 200, 0, 0, 200, 200, 0)->eyeColor(2, 200, 0, 0, 200, 200, 0)->color(22, 160, 133)->generate($waUrl),
            ) !!}" alt="QR WhatsApp" width="120">
        ...
        <table class="bill-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($electricUsage * $global->electric_price, 0, ',', '.') }}
                    </td>
                </tr>
                <tr>
        ...
        <div class="highlight">
            💡 Pembayaran sebelum tanggal 10 bulan ini akan membantu menjaga layanan tetap lancar tanpa denda
            keterlambatan.
        </div>
        ...
        <div class="footer">
            KostASH.id &bull; PH4Q+X6G, RT.02/RW.01, Plosorejo, Menganti, Kec. Menganti, Kabupaten Gresik, Jawa Timur
            61174 <br>
